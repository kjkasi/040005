...
#define ENABLE_EXPORT_RF_DEVICE			1	//add by WNC_JH
...
static void PCIE_Device_PERST(int portnum)
{
	...
	*/
		...
		REG32(0xb8000040)=REG32(0xb8000040)|(6);
...
#if ENABLE_EXPORT_RF_DEVICE
struct rtl8192cd_priv * g_rtl8192cd_priv = NULL;
#endif
