...
const struct cl_option cl_options[] =
{
  ...
  { "-MD",
    ...
    N_OPTS, 2, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_SEPARATE },
  { "-MF",
    N_("-MF <file>	Write dependency output to the given file"),
    N_OPTS, 2, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_SEPARATE },
  { "-MG",
  ...
  { "-MMD",
    ...
    N_OPTS, 3, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_SEPARATE },
  { "-MP",
  ...
  { "-O",
    ...
    N_OPTS, 1, CL_COMMON | CL_JOINED | CL_MISSING_OK },
  { "-Os",
  ...
  { "-Wformat-zero-length",
    0,
    N_OPTS, 19, CL_C | CL_ObjC },
  { "-Wformat=",
    0,
    N_OPTS, 8, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED },
  { "-Wimplicit",
    0,
    N_OPTS, 9, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX },
  { "-Wimplicit-function-declaration",
    N_("Warn about implicit function declarations"),
    N_OPTS, 30, CL_C | CL_ObjC },
  { "-Wimplicit-int",
    N_("Warn when a declaration does not specify a type"),
    N_OPTS, 13, CL_C | CL_ObjC },
  { "-Wimport",
  ...
  { "-Wsynth",
    ...
    N_OPTS, 6, CL_CXX | CL_ObjCXX },
  { "-Wsystem-headers",
    N_("Do not suppress warnings from system headers"),
    N_OPTS, 15, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_COMMON },
  { "-Wtraditional",
  ...
  { "-Wundeclared-selector",
    0,
    N_OPTS, 20, CL_ObjC | CL_ObjCXX },
  { "-Wundef",
    N_("Warn if an undefined macro is used in an #if directive"),
    N_OPTS, 6, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX },
  { "-Wuninitialized",
  ...
  { "-aux-info",
    ...
    N_OPTS, 8, CL_COMMON | CL_SEPARATE },
  { "-aux-info=",
    0,
    N_OPTS, 9, CL_COMMON | CL_JOINED },
  { "-auxbase",
    0,
    N_OPTS, 7, CL_COMMON | CL_SEPARATE },
  { "-auxbase-strip",
    0,
    N_OPTS, 13, CL_COMMON | CL_SEPARATE },
  { "-d",
    N_("-d<letters>	Enable dumps from specific passes of the compiler"),
    N_OPTS, 1, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_COMMON | CL_JOINED },
  { "-dumpbase",
    N_("-dumpbase <file>	Set the file basename to be used for dumps"),
    OPT_d, 8, CL_COMMON | CL_SEPARATE },
  { "-fPIC",
    0,
    N_OPTS, 4, CL_COMMON },
  { "-fPIE",
  ...
  { "-fabi-version=",
    0,
    N_OPTS, 13, CL_COMMON | CL_JOINED | CL_UINTEGER },
  { "-faccess-control",
  ...
  { "-falign-functions=",
    0,
    N_OPTS, 17, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE | CL_UINTEGER },
  { "-falign-jumps",
  ...
  { "-falign-labels=",
    0,
    N_OPTS, 14, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE | CL_UINTEGER },
  { "-falign-loops",
  ...
  { "-fall-virtual",
    0,
    N_OPTS, 12, CL_CXX | CL_ObjCXX },
  { "-falt-external-templates",
    N_("Change when template instances are emitted"),
    N_OPTS, 23, CL_CXX | CL_ObjCXX },
  { "-fargument-alias",
  ...
  { "-fcse-skip-blocks",
    ...
    N_OPTS, 16, CL_COMMON },
  { "-fdafile-relative",
    N_("Put gcda file in relative instead of absolute path"),
    N_OPTS, 16, CL_COMMON },
  { "-fdata-sections",
  ...
  { "-fdiagnostics-show-location=",
    ...
    N_OPTS, 27, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE },
  { "-fdollars-in-identifiers",
    N_("Permit '$' as an identifier character"),
    N_OPTS, 23, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX },
  { "-fdump-",
    N_("-fdump-<type>	Dump various compiler internals to a file"),
    N_OPTS, 6, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_REJECT_NEGATIVE },
  { "-fdump-unnumbered",
    N_("Suppress output of instruction numbers and line number notes in debugging dumps"),
    OPT_fdump_, 16, CL_COMMON },
  { "-felide-constructors",
    0,
    N_OPTS, 19, CL_CXX | CL_ObjCXX },
  ...
  { "-fexec-charset=",
    ...
    N_OPTS, 14, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_REJECT_NEGATIVE },
  ...
  { "-ffixed-",
    ...
    N_OPTS, 7, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE },
  { "-ffixed-form",
    0,
    OPT_ffixed_, 11, CL_C | CL_ObjC },
  { "-ffixed-line-length-",
    0,
    OPT_ffixed_, 19, CL_C | CL_ObjC | CL_JOINED },
  { "-ffloat-store",
  ...
  { "-fgcse",
    ...
    N_OPTS, 5, CL_COMMON },
  { "-fgcse-las",
    N_("Perform redundant load after store elimination in global common subexpression elimination"),
    N_OPTS, 9, CL_COMMON },
  { "-fgcse-lm",
  ...
  { "-fgnu-keywords",
    ...
    N_OPTS, 13, CL_CXX | CL_ObjCXX },
  { "-fgnu-runtime",
    N_("Generate code for GNU runtime environment"),
    N_OPTS, 12, CL_ObjC | CL_ObjCXX },
  ...
  { "-fimplicit-inline-templates",
    ...
    N_OPTS, 26, CL_CXX | CL_ObjCXX },
  { "-fimplicit-templates",
    N_("Emit implicit instantiations of templates"),
    N_OPTS, 19, CL_CXX | CL_ObjCXX },
  { "-finhibit-lt",
    N_("Do not output lt in function epilogue. Obsolete now"),
    N_OPTS, 11, CL_COMMON },
  { "-finhibit-ltw",
    N_("Do not output ltw in function epilogue. Obsolete now"),
    N_OPTS, 12, CL_COMMON },
  { "-finhibit-size-directive",
    N_("Do not generate .size directives"),
    N_OPTS, 23, CL_COMMON },
  { "-finhibit-st",
    N_("Do not output st in function prologue. Obsolete now"),
    N_OPTS, 11, CL_COMMON },
  { "-finline",
  ...
  { "-finput-charset=",
    ...
    N_OPTS, 15, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_REJECT_NEGATIVE },
  ...
  { "-floop-optimize",
    ...
    N_OPTS, 14, CL_COMMON },
  { "-flt",
    N_("Obsolete. Just for back compatible"),
    N_OPTS, 3, CL_COMMON },
  { "-fltw",
    N_("Obsolete. Just for back compatible"),
    N_OPTS, 4, CL_COMMON },
  ...
  { "-fmessage-length=",
    ...
    N_OPTS, 16, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE | CL_UINTEGER },
  { "-fmove-all-movables",
  ...
  { "-fname-mangling-version-",
    0,
    N_OPTS, 23, CL_CXX | CL_ObjCXX | CL_JOINED },
  { "-fnew-abi",
    0,
    N_OPTS, 8, CL_CXX | CL_ObjCXX },
  { "-fnew-ra",
  ...
  { "-fprofile-arcs",
    ...
    N_OPTS, 13, CL_COMMON },
  { "-fprofile-cache",
    N_("Place profile code in cacheable memory address"),
    N_OPTS, 14, CL_COMMON },
  { "-fprofile-generate",
  ...
  { "-frandom-seed=",
    ...
    N_OPTS, 13, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE },
  { "-freduce-all-givs",
  ...
  { "-freplace-objc-classes",
    ...
    N_OPTS, 21, CL_ObjC | CL_ObjCXX },
  { "-frepo",
    N_("Enable automatic template instantiation"),
    N_OPTS, 5, CL_CXX | CL_ObjCXX },
  ...
  { "-frerun-loop-opt",
    ...
    N_OPTS, 15, CL_COMMON },
  { "-frlxcov",
    N_("Put the code coverage initialization symbols in section .rlxcov instead of .ctors"),
    N_OPTS, 7, CL_COMMON },
  { "-frounding-math",
  ...
  { "-fsched-stalled-insns-dep=",
    ...
    N_OPTS, 25, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE | CL_UINTEGER },
  { "-fsched-stalled-insns=",
    N_("-fsched-stalled-insns=<number>       Set number of queued insns that can be prematurely scheduled"),
    N_OPTS, 21, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE | CL_UINTEGER },
  { "-fsched-verbose=",
    N_("-fsched-verbose=<number>	Set the verbosity level of the scheduler"),
    N_OPTS, 15, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE },
  ...
  { "-fsigned-bitfields",
    ...
    N_OPTS, 17, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX },
  { "-fsigned-char",
  ...
  { "-fstack-limit-register=",
    ...
    N_OPTS, 22, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE },
  { "-fstack-limit-symbol=",
    N_("-fstack-limit-symbol=<name>	Trap if the stack goes past symbol <name>"),
    N_OPTS, 20, CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE },
  { "-fstats",
  ...
  { "-ftabstop=",
    ...
    N_OPTS, 9, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_REJECT_NEGATIVE | CL_UINTEGER },
  { "-ftemplate-depth-",
    N_("-ftemplate-depth-<number>	Specify maximum template instantiation depth"),
    N_OPTS, 16, CL_CXX | CL_ObjCXX | CL_JOINED | CL_REJECT_NEGATIVE | CL_UINTEGER },
  { "-ftest-coverage",
  ...
  { "-ftrapv",
    ...
    N_OPTS, 6, CL_COMMON },
  { "-ftword",
    N_("Emit twin-word load/store instructions in programs except function prologue/epilogue"),
    N_OPTS, 6, CL_COMMON },
  { "-ftword-stack",
    N_("Follow MIPS convention: stack 8-byte aligned"),
    N_OPTS, 12, CL_COMMON },
  { "-funit-at-a-time",
  ...
  { "-funsigned-bitfields",
    ...
    N_OPTS, 19, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX },
  { "-funsigned-char",
  ...
  { "-fuse-cxa-atexit",
    ...
    N_OPTS, 15, CL_CXX | CL_ObjCXX },
  { "-fuse-uls",
    N_("Allow compiler to emit unaligned load/store instructions"),
    N_OPTS, 8, CL_COMMON },
  { "-fverbose-asm",
  ...
  { "-fwide-exec-charset=",
    ...
    N_OPTS, 19, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_REJECT_NEGATIVE },
  { "-fworking-directory",
  ...
  { "-gxcoff+",
    ...
    OPT_gxcoff, 7, CL_COMMON | CL_JOINED | CL_MISSING_OK },
  { "-idirafter",
    N_("-idirafter <dir>	Add <dir> to the end of the system include path"),
    N_OPTS, 9, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_SEPARATE },
  { "-imacros",
    N_("-imacros <file>	Accept definition of macros in <file>"),
    N_OPTS, 7, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_SEPARATE },
  { "-include",
  ...
  { "-isysroot",
    ...
    N_OPTS, 8, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_SEPARATE },
  { "-isystem",
  ...
  { "-iwithprefix",
    ...
    N_OPTS, 11, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_SEPARATE },
  { "-iwithprefixbefore",
    N_("-iwithprefixbefore <dir>	Add <dir> to the end of the main include path"),
    OPT_iwithprefix, 17, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_SEPARATE },
  { "-lang-asm",
    0,
    N_OPTS, 8, CL_C | CL_UNDOCUMENTED },
  { "-lang-objc",
    0,
    N_OPTS, 9, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_UNDOCUMENTED },
  { "-m",
    0,
    N_OPTS, 1, CL_COMMON | CL_JOINED },
  { "-nostdinc",
  ...
  { "-o",
    ...
    N_OPTS, 1, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_COMMON | CL_JOINED | CL_SEPARATE },
  { "-p",
    N_("Enable function profiling"),
    N_OPTS, 1, CL_COMMON },
  { "-pedantic",
    N_("Issue warnings needed for strict compliance to the standard"),
    N_OPTS, 8, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_COMMON },
  { "-pedantic-errors",
    N_("Like -pedantic but issue them as errors"),
    N_OPTS, 15, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_COMMON },
  { "-plinux",
    N_("Enable function profiling for Linux"),
    N_OPTS, 6, CL_COMMON },
  { "-print-objc-runtime-info",
    N_("Generate C header of platform-specific features"),
    N_OPTS, 23, CL_ObjC | CL_ObjCXX },
  { "-pros",
    N_("Enable function profiling for ROS"),
    N_OPTS, 4, CL_COMMON },
  { "-quiet",
  ...
  { "-remap",
    ...
    N_OPTS, 5, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX },
  { "-std=c++98",
  ...
  { "-w",
    ...
    N_OPTS, 1, CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_COMMON }
};
