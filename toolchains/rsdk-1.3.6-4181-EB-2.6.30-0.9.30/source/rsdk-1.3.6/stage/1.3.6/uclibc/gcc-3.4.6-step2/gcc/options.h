...
enum opt_code
{
  ...
  OPT_fdafile_relative,                   /* -fdafile-relative */
  ...
  OPT_finhibit_lt,                        /* -finhibit-lt */
  OPT_finhibit_ltw,                       /* -finhibit-ltw */
  OPT_finhibit_size_directive,            /* -finhibit-size-directive */
  OPT_finhibit_st,                        /* -finhibit-st */
  OPT_finline,                            /* -finline */
  ...
  OPT_fprofile_cache,                     /* -fprofile-cache */
