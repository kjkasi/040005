...
#define gt_ggc_m_14cp_token_block(X) do { \
  if (X != NULL) gt_ggc_mx_cp_token_block (X);\
  } while (0)
extern void gt_ggc_mx_cp_token_block (void *);
#define gt_ggc_m_8cp_token(X) do { \
  if (X != NULL) gt_ggc_mx_cp_token (X);\
  } while (0)
extern void gt_ggc_mx_cp_token (void *);
#define gt_ggc_m_15deferred_access(X) do { \
  if (X != NULL) gt_ggc_mx_deferred_access (X);\
  } while (0)
extern void gt_ggc_mx_deferred_access (void *);
...
#define gt_pch_n_14cp_token_block(X) do { \
  if (X != NULL) gt_pch_nx_cp_token_block (X);\
  } while (0)
extern void gt_pch_nx_cp_token_block (void *);
#define gt_pch_n_8cp_token(X) do { \
  if (X != NULL) gt_pch_nx_cp_token (X);\
  } while (0)
extern void gt_pch_nx_cp_token (void *);
#define gt_pch_n_15deferred_access(X) do { \
  if (X != NULL) gt_pch_nx_deferred_access (X);\
  } while (0)
extern void gt_pch_nx_deferred_access (void *);
#define gt_pch_n_16named_label_list(X) do { \
  if (X != NULL) gt_pch_nx_named_label_list (X);\
  } while (0)
extern void gt_pch_nx_named_label_list (void *);
#define gt_pch_n_20named_label_use_list(X) do { \
  if (X != NULL) gt_pch_nx_named_label_use_list (X);\
  } while (0)
...
#define gt_pch_n_11z_candidate(X) do { \
  if (X != NULL) gt_pch_nx_z_candidate (X);\
  } while (0)
extern void gt_pch_nx_z_candidate (void *);
...
#define gt_pch_n_17cxx_saved_binding(X) do { \
  if (X != NULL) gt_pch_nx_cxx_saved_binding (X);\
  } while (0)
extern void gt_pch_nx_cxx_saved_binding (void *);
...
extern void gt_pch_p_8cp_lexer
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_14cp_token_block
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_8cp_token
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_15deferred_access
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_14cp_token_cache
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_11z_candidate
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_16cp_binding_level
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_11cxx_binding
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_17cxx_saved_binding
    (void *, void *, gt_pointer_operator, void *);
