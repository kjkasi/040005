 ...
 */
static int
readelfheader (int fd, Elf_Ehdr * ehdr)
{
  errno = 0;
 ...
 */
static int
readphdrtable (int fd, Elf_Ehdr const *ehdr, Elf_Phdr ** phdrs)
{
  size_t size;
 ...
 */
static int
getmemorysize (Elf_Ehdr const *ehdr, Elf_Phdr const *phdrs,
 ...
 */
static int
truncatezeros (int fd, unsigned long *newsize)
{
 ...
 */
static int
modifyheaders (Elf_Ehdr * ehdr, Elf_Phdr * phdrs, unsigned long newsize)
{
  Elf32_Phdr *phdr;
  int i;
 ...
 */
static int
commitchanges (int fd, Elf_Ehdr const *ehdr, Elf_Phdr * phdrs,
               unsigned long newsize)
{
  size_t n;
