...
#define gpr_interlocks \
  ( mips_opts.isa == ISA_MIPS5280 || \
    mips_opts.isa == ISA_MIPS5281 || \
    mips_opts.isa == ISA_MIPS4281 || \
        ...
        case '#':
          switch (*++args)
          {
            ...
            case 't':
                  ...
                  if (s[1] == 'm' && s[2] == '0' && s[3] == 'l')
                  {
                    ...
                    if (s[1] == 'm' && s[2] == '0' && s[3] == 'h')
                    {
                      ...
                      if (s[1] == 'm' && s[2] == '0')
                      {
                        ...
                        if (s[1] == 'm' && s[2] == '1' && s[3] == 'l')
                        {
                          s += 4;
                          regno = M1L;
                        }
                        else
                          if (s[1] == 'm' && s[2] == '1' && s[3] == 'h')
                          {
                            s += 4;
                            regno = M1H;
                          }
                            ...
                            if (s[1] == 'm' && s[2] == '1')
                            {
                              ...
                              if (s[1] == 'm' && s[2] == '2' && s[3] == 'l')
                              {
                                s += 4;
                                regno = M2L;
                              }
                              else
                                if (s[1] == 'm' && s[2] == '2' && s[3] == 'h')
                                {
                                  s += 4;
                                  regno = M2H;
                                }
                                  ...
                                  { 
                                    ...
                                    if (s[1] == 'm' && s[2] == '3' && s[3] == 'l')
                                    {
                                      s += 4;
                                      regno = M3L;
                                    }
                                    else
                                      if (s[1] == 'm' && s[2] == '3' && s[3] == 'h')
                                      {
                                        s += 4;
                                        regno = M3H;
                                      }
                                        ...
                                        if (s[1] == 'm' && s[2] == '3')
                                        {
                                          ...
                                          if (s[1] == 'c' && s[2] == 'b' && s[3] == 's' && s[4] == '0') 
                                          {
                                            s += 5;
                                            regno = CBS0;
                                          }
                                          else
                                            if (s[1] == 'c' && s[2] == 'b' && s[3] == 's' && s[4] == '1')
                                            {
                                              s += 5;
                                              regno = CBS1;
                                            }
              ...
              switch (t)
              {
                case '1': /* m0(3), m1(7), m2(11), m3(15) */
                  if (regno <= 0 || regno > 15 
                      || (regno & 3) != 3)
                    as_bad (_("RADIAX: illegal register (%d) in %s type d%c"), regno, str, t);
                  break;
                ...
                case '4': /* LXC0 registers */
                  if (regno > 31)
                    as_bad (_("RLX: illegal register (%d) in %s type d%c"), regno, str, t);
                  break; 
              ...
              switch (c)
              {
                case 'd': INSERT_OPERAND (RD, *ip, regno); break;
                case 's': INSERT_OPERAND (RS, *ip, regno); break;
                case 't': INSERT_OPERAND (RT, *ip, regno); break;
              } 
            ...
            case 'k':
               ...
               * to figure out where it goes in the instruction.  */
              if (regno == 32)
                as_bad (_("RLX: illegal register (%d) in %s"), regno, str);

              switch (c)
              {
                case 'u': INSERT_OPERAND (RD, *ip, regno); break;
                case 'k': INSERT_OPERAND (RD, *ip, regno); break;
              } 
            ...
            case '~':
              ...
              ip->insn_opcode |=
                ((imm_expr.X_add_number & OP_MASK_IMMIDATE88) << OP_SH_IMMIDATE88);
              imm_expr.X_op = O_absent;
              s = expr_end;
              continue; 
...
static const struct mips_cpu_info mips_cpu_info_table[] =
{
  ...
  { "rlx4281",        1,      ISA_MIPS4281,   CPU_RLX4281 },
  { "rlx5181",        1,      ISA_MIPS5181,   CPU_RLX5181 },
  { "rlx5281",        1,      ISA_MIPS5281,   CPU_RLX5281 },
