...
#define INSN_ISA4281              0x00004000   /* LX4180, RLX4181 */
#define INSN_ISA5181              0x00008000   /* LX4180, RLX4181 */
#define INSN_ISA5280              0x00010000   /* LX4180, RLX4181 */
#define INSN_ISA5281              0x00020000   /* LX4180, RLX4181 */
...
#define       ISA_MIPS4281    (ISA_MIPS1 | INSN_ISA4281)
#define       ISA_MIPS5181    (ISA_MIPS1 | INSN_ISA5181)
#define       ISA_MIPS5281    (ISA_MIPS1 | INSN_ISA5281)
...
#define OPCODE_IS_MEMBER(insn, isa, cpu)				\
    (((insn)->membership & isa) != 0					\
     ...
     || (cpu == CPU_RLX4281 && ((insn)->membership & INSN_ISA4281) != 0)	\
     || (cpu == CPU_RLX5181 && ((insn)->membership & INSN_ISA5181) != 0)	\
     || (cpu == CPU_RLX5281 && ((insn)->membership & INSN_ISA5281) != 0)	\
