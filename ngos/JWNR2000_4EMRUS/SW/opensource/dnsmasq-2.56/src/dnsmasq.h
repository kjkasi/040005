...
#define OPT_PARENTALCONTROL 35
#endif
#if defined(FEATURE_BLKSITES)
#define OPT_BLKSITES 36
#ifdef FEATURE_BLKSITESBANNER
#define OPT_BANNERSRVIP 37
#endif
#endif
#if defined(FEATURE_AUTOBRIDGELAN2WAN)
#define OPT_IGNRDHCP 38
#endif
#ifdef FEATURE_TRIPLEPLAY
#define SERVICEID_IPTV          "2"
#define SERVICEID_BROADBAND     "3"
#endif
/* NETGEAR Changes End*/
...
struct dhcp_lease {
  ...
  char *opt125_vendor_oui; /* Opt125/TR-111 data */
  char *opt125_serial_num; /* Opt125/TR-111 data */
  char *opt125_product_class; /* Opt125/TR-111 data */
#endif
/* NETGEAR Changes Start*/
#ifdef FEATURE_TRIPLEPLAY
  char  serviceID[2]; 
...
/* NETGEAR Changes Start*/
#if defined(FEATURE_PARENTALCONTROL)
#define DEVICEID_FILE "/var/etc/deviceidinfo.txt"
#endif

#if defined(FEATURE_BLKSITES)
typedef struct blkSites_s {
	char keyword[512];
	struct blkSites *next;
}blkSites_t;

extern blkSites_t *blkSitesList;

typedef struct blkTrustedIp_s {
	char ip[32];
	struct blkTrustedIp *next;
}blkTrustedIp_t;


extern blkTrustedIp_t *blkTrustedIpList;

#ifdef FEATURE_EMAIL
#define WEBSRV_PID_FILE "/var/run/webserver.pid"
#define LOOPBACK_IP "127.0.0.1"
#define SIG_BLKSITES_FILE "/tmp/blksites"
#endif
#endif
#ifdef FEATURE_TRIPLEPLAY
typedef struct lanDhcpOptionList_s {
        char dhcpoptionvalue[256];
        struct lanDhcpOptionList *next;
}lanDhcpOptionList_t;
#endif
/* NETGEAR Changes End*/
...
/* NETGEAR Changes Start*/
#if defined(FEATURE_PARENTALCONTROL)
  int parentalcontrol; /* parental control enabled or not */
#endif
#if defined(FEATURE_AUTOBRIDGELAN2WAN)
  char *ignrdhcp_option;
  char *ignrdhcp_value;
#endif
#ifdef FEATURE_TRIPLEPLAY
  char *landhcpoption60;
#endif
/* NETGEAR Changes End*/
} *daemon;
