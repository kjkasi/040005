...
#define CONF_FILE "/var/etc/upnpd.conf" //Changed the default path for UPnP feature. 
...
#define XML_PATH_DEFAULT "/var/etc/linuxigd" //Changed the default path for UPnP feature.
