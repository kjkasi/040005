...
typedef struct PPPoEConnectionStruct {
	...
	/* Westell Start */
    PPPoETag discoveredServiceName;		/* Discovered service name */
    PPPoETag discoveredACName;		/* Discovered access concentrator name */
#ifdef BUILD_ERT_SPECIFIC
    int ertAcName;
    int receivedPADO;
#endif
...
int discovery(PPPoEConnection *conn, int number_of_retries);
/* Westell End */
unsigned char *findTag(PPPoEPacket *packet, UINT16_t tagType,
		       PPPoETag *tag);

/* Return codes for discovery() */
#define PPPOE_OK 0
#define PPPOE_USER_REQUEST 1
#define PPPOE_TIMEOUT_PADO 2
#define PPPOE_TIMEOUT_PADS 3
#ifdef BUILD_ERT_SPECIFIC
#define PPPOE_INVALID_ACNAME 4
#endif
