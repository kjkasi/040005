...
form_duid(struct data_string *duid, const char *file, int line)
{
	...
	if (!stateless) {
             /* Netgear - Change done to generate Link Local (LL) type DUID
              * when stateful mechanism is used instead LLT  */
             /* This was done to prevent dhclient to generate new DUID everytime
              * it restarted or after reboot */
