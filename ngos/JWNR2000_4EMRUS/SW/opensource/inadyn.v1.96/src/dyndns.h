...
#define MEM_3322_SERVER_NAME "members.3322.org" /* Netgear added variable */
...
#define DYNDNS_DEFAULT_CONFIG_FILE	"/var/etc/inadyn.conf"	/* Westell - added var */
...
/* 3322.org specific update address format */	
#define ORG_3322_GET_MY_IP_HTTP_REQUEST_FORMAT \
        "GET /dyndns/update?" \
	     "system=%s&" \
	     "hostname=%s&" \
	     "myip=%s&" \
...
#define DYNDNS_MY_USERNAME_LENGTH	60 /*chars*/
#define DYNDNS_MY_PASSWORD_LENGTH	60 /*chars*/
/* Netgear Chnages Ends Here */
