...
static void wpsProcStatus();
static int wpsStatus;
/* Westell Add End */
...
static void wpsProcStatus()
	{
        FILE *pFile = NULL;
       	...
       	pFile = fopen ("/tmp/WpsProcStatus", "w");
      	if (pFile != NULL)
         {
			switch(wpsStatus)
			{
				case 1:
                      fwrite (SEEK, 1, sizeof (SEEK), pFile);
				break;
				case 2:
                      fwrite (PASS, 1, sizeof (PASS), pFile);
				break;
				case 4:
                      fwrite (TIMEOUT, 1, sizeof (TIMEOUT), pFile);
				break;
				default:
