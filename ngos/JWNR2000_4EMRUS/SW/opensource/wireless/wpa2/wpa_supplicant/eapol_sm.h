...
#define WPA_STATUSFILE_PATH "/tmp/8021xAuthStatus"
typedef enum { WPADisconnected,WPALogoff,WPAConnecting,WPAAuthenticating,WPAAuthenticated,WPAHeld,WPARestart,
               WPAForceAuthorized,WPAForceUnauthorized,WPAInitialize,WPAFailure,WPASuccess} SMstat;
#endif
