...
#define ping_full_usage \
	...
	"\t-t TIMEOUT\tTimeout if no response.\n" \
...
#define syslogd_trivial_usage \
	"[OPTION]..."
/* NETGEAR Changes start added extra parameter -v */
#define syslogd_full_usage \
	...
	"\t-v [version number]\tFirmware version of the target board." 
/* NETGEAR Changes end */
...
#define tftpd_trivial_usage \
	"[-a address] [-p port] [-s] [-d directory]"
#define tftpd_full_usage \
	"Transfers a file from/to a tftp server.\n" \
	"Options:\n" \
	"\t-a\tSpecify a specific address to listen to.\n" \
	"\t-p\tSpecify a specific port to listen to.\n" \
	"\t-s\tDaemonize.\n" \
	"\t-d\tSpecify a directory from/to which the files can be transferred.\n"
...
#define traceroute_full_usage \
	...
	"\t-v\tVerbose output\n" \
	"\t-e\tPrint numeric ICMP error code.\n" \
...
#define udhcpc_full_usage \
	...
	"\t-T,\t--timeout=seconds\tTry to get the lease for the amount of seconds (default: 3)\n" \
